...
const range = XLSX.utils.decode_range(worksheet["!ref"]); //Grabs number of rows and columns

//console.log(range) every coluns e rows
...
XLSX.writeFile(newWb, "scoreWithCurve.xlsx");